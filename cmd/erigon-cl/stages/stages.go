...
func ConsensusStages(ctx context.Context, historyReconstruction StageHistoryReconstructionCfg, beaconsBlocks StageBeaconsBlockCfg, beaconState StageBeaconStateCfg) []*stages.Stage {
	return []*stages.Stage{
		{
...
var ConsensusUnwindOrder = stages.UnwindOrder{
	stages.BeaconState,
	stages.BeaconBlocks,
}

var ConsensusPruneOrder = stages.PruneOrder{
	stages.BeaconState,
	stages.BeaconBlocks,
}
