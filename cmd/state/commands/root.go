...
import (
	"encoding/json"
	"fmt"
	genesis2 "github.com/ledgerwatch/erigon/core/types"
	"os"
	"path/filepath"
...
func genesisFromFile(genesisPath string) *genesis2.Genesis {
...
func getChainGenesisAndConfig() (genesis *genesis2.Genesis, chainConfig *chain2.Config) {
	if chain == "" {
