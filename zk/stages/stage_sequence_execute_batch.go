...
// func doInstantCloseAfterUnwindOfBatchVerificationErrorIfNeeded(batchContext *BatchContext, batchState *BatchState, isLastBatchPariallyProcessed bool, batchCounters *vm.BatchCounterCollector) (bool, error) {
// 	// instantClose, err := batchContext.sdb.hermezDb.GetJustUnwound(blockNumber)
// 	// if err != nil || !instantClose {
// 	// 	return false, err // err here could be nil as well
// 	// }

// 	// if err = batchContext.sdb.hermezDb.DeleteJustUnwound(blockNumber); err != nil {
// 	// 	return false, err
// 	// }

// 	if !isLastBatchPariallyProcessed || !batchState.isLimboRecovery() {
// 		return false, nil
// 	}
...
func updateStreamAndCheckRollback(
	...
	for _, verifierBundle := range checkedVerifierBundles {
		...
		// if err = batchContext.sdb.hermezDb.WriteJustUnwound(verifierBundle.Request.GetLastBlockNumber()); err != nil {
		// 	return false, err
		// }
